<template>
  <div class="card mb-4">
    ...
    <span><i class="fab fa-buffer"></i> Direct manager</span>
  </div>

 <div class="card-body">
   <div class="row">

       <div class="col-md-12" v-if="questionsList && questionsList.manager_question_list">
         <!-- Evaluation Factors -->
 <div class="card mb-4">
   ...
   <div class="card-body">
     ...
     <div class="row">
       ...
       <div :class="question.type == 'text'?'col-md-12':'col-md-2'" v-for="(question, questionIndex) in questionsList.manager_question_list" :key="questionIndex">
...
<div class="col-md-12">
<!--  Direct manager Recommendations -->
<div class="card mb-4">
  ...
  computed: {
     candidateIdComputed(){
      ...
      btnDisabledValidation(){
        if(this.questionsList && this.questionsList.manager_question_list){
           return this.questionsList.manager_question_list.length != this.evaluationObject.evaluations.length && this.evaluationObject.hire == null
        }
     }
  },
  methods: {
